...
export const ui = {
  zh: {
    ...
    "cta.title": "加入我们的社区",
    "cta.desc":
      "关注 AI+X seminar 的微信公众号、Bilibili 与小红书账号，获取最新讲座通知。",
    "cta.button": "了解参与方式",
    ...
    "about.logistics.archive.value":
      "讲座内容通过 Bilibili、微信公众号与小红书账号 AI+X seminar 发布",
    "about.organizers.title": "组织者",
    "about.organizers.desc":
      "AI+X Seminar 由 Fan Zhou、Chengchun Shi、Bang Liu 与 Xiaowu Dai 共同组织。",
    ...
    "info.audience.f2": "关注微信公众号、Bilibili 与小红书账号 AI+X seminar 获取通知",
    "info.audience.f3": "直播中可使用弹幕或评论提问,讲者会在 QA 环节回应",
    "info.audience.f4": "讲座结束后回放将通过 Bilibili 发布",
    ...
    "info.speaker.f6": "讲座内容允许在 Bilibili、微信公众号与小红书发布或留存",
  ...
  en: {
    ...
    "about.organizers.desc":
      "AI+X Seminar is organized by Fan Zhou, Chengchun Shi, Bang Liu, and Xiaowu Dai.",
